  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Create a Memorial Event</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {eventTypes.map((type) => (
          ...
          >
            <div className="flex items-center justify-center h-14 w-14 rounded-lg bg-white shadow-sm mb-4">
              {type.icon}
            </div>
      ...
      <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-blue-800 mb-3">Need Help Choosing?</h2>
        <ul className="space-y-2 text-blue-700">
          <li className="flex items-start">
            <span className="font-medium mr-2">• Memorial Service:</span> Best for formal remembrance ceremonies, often held shortly after a passing.
          </li>
          <li className="flex items-start">
            <span className="font-medium mr-2">• Anniversary Remembrance:</span> Ideal for yearly memorial gatherings on significant dates.
          </li>
          <li className="flex items-start">
            <span className="font-medium mr-2">• Memorial Gathering:</span> Perfect for informal meetups, celebration of life events, or charity functions.
          </li>
        </ul>
      </div>
    </div>
